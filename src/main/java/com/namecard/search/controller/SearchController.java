...
import com.namecard.search.dto.request.SearchRequest;
...
public class SearchController {
    ...
    @GetMapping("/users")
    public ApiResult<List<SearchUsersResult>> userSearch(@RequestBody SearchRequest searchRequest) {
        return success(memberService.getSearchUsers(searchRequest.getUserName()));
    }
}
